...
instance P'.Mergeable DeleteValueResponse where
  mergeAppend (DeleteValueResponse x'1 x'2) (DeleteValueResponse y'1 y'2)
   = DeleteValueResponse (P'.mergeAppend x'1 y'1) (P'.mergeAppend x'2 y'2)
 
instance P'.Default DeleteValueResponse where
  defaultValue = DeleteValueResponse P'.defaultValue P'.defaultValue
 
instance P'.Wire DeleteValueResponse where
  wireSize ft' self'@(DeleteValueResponse x'1 x'2)
   = case ft' of
       10 -> calc'Size
  ...
  wirePut ft' self'@(DeleteValueResponse x'1 x'2)
   = case ft' of
       10 -> put'Fields
       11 -> do
...
instance P'.MessageAPI msg' (msg' -> DeleteValueResponse) DeleteValueResponse where
  getVal m' f' = f' m'
 
instance P'.GPB DeleteValueResponse
 
instance P'.ReflectDescriptor DeleteValueResponse where
...
instance P'.TextMsg DeleteValueResponse where
  textPut msg
   = do
